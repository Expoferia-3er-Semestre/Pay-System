 ...
 * @author Suglin
 */
public class uiPlantilla extends javax.swing.JFrame {
    ...
    public uiPlantilla(Empleado empleado) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(uiPlantilla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new uiPlantilla().setVisible(true);
            }
        });
    }
